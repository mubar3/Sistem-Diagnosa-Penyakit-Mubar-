            ...
            if(!empty($input)) {
                ...
                foreach($gejala->penyakits as $penyakit) {
                    if(empty($data_penyakit[$penyakit->id])){
                        $data_penyakit[$penyakit->id] = [$penyakit, [$gejala, $opts[1], $penyakit->pivot->value_cf ,$this->tingkat_keyakinan($opts[1]) ,$this->tingkat_keyakinan($penyakit->pivot->value_cf)]];
                        // .'('.$this->tingkat_keyakinan($opts[1]).')'
                    } else {
                        array_push($data_penyakit[$penyakit->id], [$gejala, $opts[1], $penyakit->pivot->value_cf ,$this->tingkat_keyakinan($opts[1]) ,$this->tingkat_keyakinan($penyakit->pivot->value_cf)]);
                    }
                    ...
                    $hasil_diagnosa[$final[0]->id] = [
                        ...
                        'gejala' => [
                            [
                                ...
                                'cf_user' => $final[$key][1],
                                'status_user' => $final[$key][3],
                                'cf_role' => $final[$key][2],
                                'status_role' => $final[$key][4],
